  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row gap-10 '>
        <p>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Porro nihil quae eligendi tempore neque ex culpa? Dolorem obcaecati nulla eos sed
          inventore in aliquam quis porro praesentium magnam. Incidunt, expedita!
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo assumenda cumque maxime, et magnam provident tenetur nemo ex ullam dolore,
          asperiores saepe nam nulla impedit adipisci quae alias culpa corporis.
        </p>
      </div>
